...
function articleMaker(articleObj) {
  ...
  articleWrapper.appendChild(articleFirstP);
  articleWrapper.appendChild(articleSecondP);
  articleWrapper.appendChild(articleThirdP);
  articleWrapper.appendChild(expandButton);


  articleTitle.textContent = articleObj.title;
  articleDate.textContent = articleObj.date;
  articleFirstP.textContent = articleObj.firstParagraph;
  articleSecondP.textContent = articleObj.secondParagraph;
  articleThirdP.textContent = articleObj.thirdParagraph;
